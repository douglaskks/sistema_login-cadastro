...
<head>
    ...
    <style>
        body{
            ...
            background-image: linear-gradient(to right, rgb(150, 20, 220), rgb(67, 1, 102));
        }
        .box{
            color: white;
            position: absolute;
        ...
        fieldset{
            border: 3px solid #b714dc;
        }
        legend{
            border: 1px solid #b714dc;
            padding: 10px;
            text-align: center;
            background-color: #b714dc;
            border-radius: 8px;
        }
        .inputBox{
            position: relative;
        ...
        #submit{
            background-image: linear-gradient(to right,rgb(112, 0, 197), rgb(183, 20, 220));
            width: 100%;
            border: none;
            padding: 15px;
            color: white;
